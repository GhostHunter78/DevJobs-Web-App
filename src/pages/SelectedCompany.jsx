...
const SelectedCompany = () => {
  ...
  return (
    <div>
      <div className="px-6">
        <div className="rounded-md bg-white flex flex-col items-center pb-10 mt-[-10px]">
          <figure
          ...
          <p className="text-[20px] mt-6 font-bold text-blackWords">
            {company.company}
          </p>
          ...
          <a href={company.website} target="_blank" rel="noopener noreferrer">
            <button className="mt-[27px] bg-sky-100 text-lightBlue tetx-[16px] font-bold px-5 py-4 rounded">
              Company Site
            </button>
          </a>
        </div>
        <div className="bg-white rounded-md mt-6 py-[40px] px-6">
          ...
          <p className="mt-[10px] text-blackWords text-[20px] font-bold">
            {company.position}
          </p>
          ...
          <h2 className="text-[20px] font-bold text-blackWords mt-10">
            Requirements
          </h2>
          <p className="text-lightGray leading-relaxed text-[16px] text-left w-fit mt-8">
      ...
      <div className="rounded-t-md bg-white px-6 py-6 mt-16 w-screen">
        <a href={company.apply} target="_blank" rel="noopener noreferrer">
